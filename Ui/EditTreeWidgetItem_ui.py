...
from PySide6.QtWidgets import (QAbstractButton, QApplication, QDialog, QDialogButtonBox,
                               ...
                               QSizePolicy, QVBoxLayout, QWidget, QPushButton, QFrame, QStackedWidget,
                               QLayout, QSpinBox)
...
class Ui_Dialog(object):
    ...
    def setupEditSessionUi(self, Dialog):
        ...
        self.pushButton.setStyleSheet(u"font: 10pt;")
        ...
        self.pushButton_2.setStyleSheet(u"font: 10pt;")
        ...
        self.session_vnc = QWidget()
        self.session_vnc.setObjectName(u"session_vnc")
        self.verticalLayout_2 = QVBoxLayout(self.session_vnc)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.groupBox = QGroupBox(self.session_vnc)
        self.groupBox.setObjectName(u"groupBox")
        ...
        self.groupBox_2 = QGroupBox(self.session_vnc)
        ...
        self.stackedWidget.addWidget(self.session_vnc)
        self.session_rdp = QWidget()
        self.session_rdp.setObjectName(u"session_rdp")
        self.verticalLayout_3 = QVBoxLayout(self.session_rdp)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.groupBox_3 = QGroupBox(self.session_rdp)
        ...
        self.groupBox_4 = QGroupBox(self.session_rdp)
        ...
        self.stackedWidget.addWidget(self.session_rdp)
    ...
    def retranslateEditFolderUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\u6587\u4ef6\u5939\u7f16\u8f91", None))
        self.groupBox.setTitle(QCoreApplication.translate("Dialog", u"\u7f16\u8f91\u6587\u4ef6\u5939", None))
        self.label.setText(QCoreApplication.translate("Dialog", u"*\u6587\u4ef6\u5939\u540d", None))

    def retranslateEditSessionUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\u4f1a\u8bdd\u8bbe\u7f6e", None))
        self.pushButton.setText(QCoreApplication.translate("Dialog", u"VNC", None))
        self.pushButton_2.setText(QCoreApplication.translate("Dialog", u"RDP", None))
